...
function App() {
  ...
  return (
    <>
      ...
      <h2 className="text-2xl mt-4 text-violet-700">Has completado 0 de 0 tareas</h2>
      <div className="flex items-center mt-4">
        ...
        <div className='relative mt-4'>
          ...
          type="text"
          placeholder="Buscar..."
          className="py-2 px-4 pr-10 w-full md:w-96 border border-gray-300 rounded-md focus:outline-none focus:border-blue-400"
        />
      ...
      <h2 className="text-1xl mt-6 text-violet-700">Crea tu primera tarea!</h2>
